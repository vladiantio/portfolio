  ...
  return (
    <div>
      <div class="flex gap-4 m-3">
        ...
        <label for="otherColor" class={`size-4 rounded-full transition ${isOtherColor() ? 'ring-4 ring-primary ring-opacity-25' : ''}`} role="button" title={translate('otherColor')} aria-label={translate('otherColor')}>
