  ...
  return (
    <div>
      <div className="flex gap-4 m-3">
        ...
        <label htmlFor="otherColor" className={`size-4 rounded-full transition ${isOtherColor ? 'ring-4 ring-primary ring-opacity-25' : ''}`} role="button" title="Otro color" aria-label="Otro color">
        ...
        <input type="color" className="sr-only bottom-0 left-0" id="otherColor" onInput={ev => handleChangeColor(ev.currentTarget.value)} value={currentColor} />
      </div>
    </div>
  );
}
