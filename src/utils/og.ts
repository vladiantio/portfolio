...
type AstroRenderParameters = Parameters<
  typeof experimental_AstroContainer.prototype.renderToString
>;
...
export const OG = async (...parameters: AstroRenderParameters) => {
  const fonts: Font[] = [
    {
      name: "Figtree",
      data: await fs.readFile("./src/assets/og/fonts/Figtree-Regular.ttf"),
      weight: 400,
    },
    {
      name: "Figtree",
      data: await fs.readFile("./src/assets/og/fonts/Figtree-Bold.ttf"),
      weight: 700,
    },
    {
      name: "Figtree",
      data: await fs.readFile("./src/assets/og/fonts/Figtree-Black.ttf"),
      weight: 900,
    },
  ];
